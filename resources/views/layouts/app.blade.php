...
-->
        ...
        <script src="{{asset('templates/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js')}}"></script>
    </head>
...
<body>
            ...
            <div class="row">
                <div class="col-md-3 col-md-offset-1">
                    <div class="first-image">
                        <img src="{{asset('assets/img/cook_01.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-3">
                    <div class="second-image">
                        <img src="{{asset('assets/img/cook_02.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <a href="menu.html">
                        <img src="{{asset('assets/img/cook_breakfast.png')}}" alt="Breakfast">
                        <h4>Breakfast</h4>
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <a href="menu.html">
                        <img src="{{asset('assets/img/cook_lunch.png')}}" alt="Lunch">
                        <h4>Lunch</h4>
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <a href="menu.html">
                        <img src="{{asset('assets/img/cook_dinner.png')}}" alt="Dinner">
                        <h4>Dinner</h4>
                        </a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <a href="menu.html">
                        <img src="{{asset('assets/img/cook_dessert.png')}}" alt="Desserts">
                        <h4>Desserts</h4>
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-2 col-sm-12">
                    <div class="left-image">
                        <img src="{{asset('assets/img/book_left_image.jpg')}}" alt="">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="food-item">
                        <h2>Breakfast</h2>
                        <img src="{{asset('assets/img/breakfast_item.jpg')}}" alt="">
                ...
                <div class="col-md-4">
                    <div class="food-item">
                        <h2>Lunch</h2>
                        <img src="{{asset('assets/img/lunch_item.jpg')}}" alt="">
                ...
                <div class="col-md-4">
                    <div class="food-item">
                        <h2>Dinner</h2>
                        <img src="{{asset('assets/img/dinner_item.jpg')}}" alt="">
    ...
    <section class="our-blog">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="blog-post">
                        <img src="{{asset('assets/img/blog_post_01.jpg')}}" alt="">
                ...
                <div class="col-md-6">
                    <div class="blog-post">
                        <img src="{{asset('assets/img/blog_post_02.jpg')}}" alt="">
                ...
                <div class="col-md-6">
                    <div class="blog-post">
                        <img src="{{asset('assets/img/blog_post_03.jpg')}}" alt="">
                ...
                <div class="col-md-6">
                    <div class="blog-post">
                        <img src="{{asset('assets/img/blog_post_04.jpg')}}" alt="">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <p>Copyright &copy; 2023 Victory </p>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <p>Re-Design: <i class="fa-solid fa-heart" style="color: #ff0000;"></i> Ahmed</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script>window.jQuery || document.write("<script src='{{asset('templates/js/vendor/jquery-1.11.2.min.js')}}'><\/script>")</script>
